...
**Current Task:** `CTXB-P13-T53` — Keep Force Live edges visible
...
- `CTXB-P13-T53` — Keep Force Live edges visible.
- Rationale: Live Force must preserve the conventional graph contract: glyph nodes plus visible straight links. Edges disappearing or becoming too faint after `Live` is a canvas regression and should be fixed before deeper Force polish.
...
- Current: `CTXB-P13-T53` Keep Force Live edges visible.
