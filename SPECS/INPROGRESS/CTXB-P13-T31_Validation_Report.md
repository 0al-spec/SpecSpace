...
- Desktop `1440x900`: selected `SG-SPEC-0001`, ran `Markdown export`,
  ...
  manifest diagnostics rendered as a read-only stats grid, and no export-flow
  console errors were emitted.
- Mobile `390x844`: selected `SG-SPEC-0001`, ran `Markdown export`,
  preview rendered, Copy and Download became enabled, diagnostics stacked into
  a `2x2` stats grid, and the Markdown preview scrolled independently.
