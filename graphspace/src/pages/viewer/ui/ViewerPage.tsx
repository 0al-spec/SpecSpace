...
export function ViewerPage({
  ...
  const workspaceApiUrls = useMemo(
    () => ({
      ...
      realIdeaAnswerContinuationExecute: workspaceApiUrl(
        "/api/v1/real-idea-answer-continuation/execute",
        workspace,
      ),
      ...
      ideaToSpecRepairRerunExecute: workspaceApiUrl(
      ...
      ideaToSpecCandidateApprovalExecute: workspaceApiUrl(
        "/api/v1/idea-to-spec-candidate-approval/execute",
        workspace,
      ),
      ideaToSpecPromotionRequestExecute: workspaceApiUrl(
      ...
      ideaToSpecPromotionReviewExecute: workspaceApiUrl(
