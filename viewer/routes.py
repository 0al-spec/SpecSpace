...
GET_ROUTES: dict[str, RouteSpec] = {
    ...
    "/api/v1/operator-session": RouteSpec(
        "handle_v1_operator_session",
        pass_parsed=True,
    ),
    ...
    "/api/v1/real-idea-entry-requests": RouteSpec(
...
POST_ROUTES: dict[str, RouteSpec] = {
    ...
    "/api/v1/real-idea-answer-continuation/execute": RouteSpec(
    ...
    "/api/v1/idea-to-spec-repair-rerun-request-gate/execute": RouteSpec(
    ...
    "/api/v1/idea-to-spec-repair-rerun/publish": RouteSpec(
    ...
    "/api/v1/idea-to-spec-candidate-approval/execute": RouteSpec(
        "handle_v1_idea_to_spec_candidate_approval_execute_post",
        pass_parsed=True,
    ),
    "/api/v1/idea-to-spec-promotion-request/execute": RouteSpec(
    ...
    "/api/v1/idea-to-spec-promotion-review-confirmation": RouteSpec(
    ...
    "/api/v1/idea-to-spec-read-model-publication/execute": RouteSpec(
