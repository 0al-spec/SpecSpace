    ...
    *,
    ...
    try:
        ...
        return HTTPStatus.UNPROCESSABLE_ENTITY, {
            "error": f"{CREATION_REQUEST_FILENAME} is unreadable",
        }
    if raw is None:
    ...
    *,
    ...
    with _STATE_LOCK:
        ...
        try:
            ...
            return HTTPStatus.CONFLICT, {
                "error": "Product workspace creation state changed concurrently.",
            ...
            return HTTPStatus.UNPROCESSABLE_ENTITY, {
                "error": "Product workspace creation state could not be persisted.",
