...
MANAGED_OPERATIONS: tuple[ManagedOperation, ...] = (
    ...
    ManagedOperation(
        ...
        overwrite_policy="Builds a fresh draft import preview, then refreshes the request gate for the active repair request/session.",
        timeout_policy="Bounded by platform_execution_timeout_seconds; timeout does not execute repair rerun.",
        replay_policy="Gate construction is replay-safe and leaves the repair rerun request active; only repair_rerun_execute consumes the request.",
