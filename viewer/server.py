...
class ViewerHandler(BaseHTTPRequestHandler):
    ...
    handle_v1_real_idea_entry_requests = (
        specspace_v1_api.handle_v1_real_idea_entry_requests
    )
    ...
    handle_v1_real_idea_intake_execution_requests = (
        specspace_v1_api.handle_v1_real_idea_intake_execution_requests
    )
    handle_v1_real_idea_intake_execution_request_post = (
        specspace_v1_api.handle_v1_real_idea_intake_execution_request_post
    )
    handle_v1_real_idea_answer_continuation_execution_requests = (
        specspace_v1_api.handle_v1_real_idea_answer_continuation_execution_requests
    )
    handle_v1_real_idea_answer_continuation_execution_request_post = (
        specspace_v1_api.handle_v1_real_idea_answer_continuation_execution_request_post
    )
    ...
    handle_v1_idea_to_spec_repair_rerun_request_gate_execute_post = (
        specspace_v1_api.handle_v1_idea_to_spec_repair_rerun_request_gate_execute_post
    )
    ...
    handle_v1_project_local_ontology_review_decision_post = (
        specspace_v1_api.handle_v1_project_local_ontology_review_decision_post
    )
    ...
    handle_v1_idea_to_spec_candidate_approval_execute_post = (
        specspace_v1_api.handle_v1_idea_to_spec_candidate_approval_execute_post
    )
    handle_v1_idea_to_spec_promotion_request_execute_post = (
        specspace_v1_api.handle_v1_idea_to_spec_promotion_request_execute_post
    )
    ...
    handle_v1_idea_to_spec_promotion_review_execute_post = (
        specspace_v1_api.handle_v1_idea_to_spec_promotion_review_execute_post
    )
    handle_v1_idea_to_spec_promotion_review_confirmation_post = (
        specspace_v1_api.handle_v1_idea_to_spec_promotion_review_confirmation_post
    )
    ...
    handle_v1_idea_to_spec_read_model_publication_execute_post = (
        specspace_v1_api.handle_v1_idea_to_spec_read_model_publication_execute_post
    )
